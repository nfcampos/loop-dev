...
*This post closes the loop driven development series. The [README](README.md) makes the argument and ends with a question — once you see code this way, is writing software really so different from training a model? — and the three practical posts ([a corpus benchmark](01-ldd-in-practice.md), [chart rendering](02-ldd-render-fidelity.md), [a performance campaign](03-ldd-perf.md)) keep raising it from different angles. This post takes the question seriously.*
